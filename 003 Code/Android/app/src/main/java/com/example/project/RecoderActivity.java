...
public class RecoderActivity extends AppCompatActivity {
        ...
        audioRecordImageBtn.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                if(isRecording) {
                    ...
                    audioRecordImageBtn.setImageDrawable(getResources().getDrawable(R.drawable.recoder_image, null)); // 녹음 상태 아이콘 변경
                    ...
                    if(checkAudioPermission()) {
                        ...
                        audioRecordImageBtn.setImageDrawable(getResources().getDrawable(R.drawable.baseline_recording_red, null)); // 녹음 상태 아이콘 변경
    ...
    private void playAudio(File file) {
        ...
        playIcon.setImageDrawable(getResources().getDrawable(R.drawable.baseline_pause, null));
        isPlaying = true;
    ...
    private void stopAudio() {
        playIcon.setImageDrawable(getResources().getDrawable(R.drawable.baseline_play, null));
        isPlaying = false;
        mediaPlayer.stop();
    }
